...
def main():
    ...
    gen.generar_dataset(20, 8, 5, 6, seed=20, filename="datasets/d1.txt")
    gen.generar_dataset(30, 8, 5, 6, seed=9, filename="datasets/d2.txt")
    gen.generar_dataset(50, 8, 7, 8, seed=10, filename="datasets/d3.txt")
    gen.generar_dataset(100, 10, 7, 8, seed=11, filename="datasets/d4.txt")
    gen.generar_dataset(200, 15, 15, 15, seed=12, filename="datasets/d5.txt")
    gen.generar_dataset(300, 15, 15, 15, seed=12, filename="datasets/d6.txt")
